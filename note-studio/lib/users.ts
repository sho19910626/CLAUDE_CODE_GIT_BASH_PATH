// 利用者アカウントの保管。
//
// 共有パスワード 1 つの方式をやめ、1 人 1 アカウントにした理由:
//   - 顧客企業名と実績数値を扱うため、誰が見たか・誰が消したかを人単位で辿りたい
//   - 退職・異動のたびに全員のパスワードを変える運用が続かない
//     (アカウント制なら、その人のアカウントだけ止めれば済む)
//   - 削除や書き出しといった重い操作を、一部の人だけに限りたい
//
// アカウントもクラウド(共有データベース)に置く。各自のPCには何も持たせない。
